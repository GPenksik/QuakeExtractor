...
namespace UnityQuake.Source
{
	public static class cl_main
	{
		...
		*/
		...
		{
			Cbuf.Cmd_AddCommand("reconnect", CL_Cmd.Host_Reconnect_f, 0);
		}
	}


	public static class CL_Cmd
	{
		public static void Host_Reconnect_f(Args args)
		{
			// SCR_BeginLoadingPlaque ();
			cl_main.cls.signon = 0;     // need new connection messages
		}
	}
}